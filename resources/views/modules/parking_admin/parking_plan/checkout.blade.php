                    ...
                    <x-card>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control py-2 @error('cardName') is-invalid @enderror"
                                wire:model="cardName" placeholder="Titular de la Tarjeta">
                            @error('cardName')
                        ...
                        <div class="mb-3">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text"
                                    class="form-control py-2 border-start-0 ps-0 @error('cardNumber') is-invalid @enderror"
                        ...
                        <div class="row">
                            <div class="col-6 mb-3">
                                ...
                                <div class="input-group">
                                    <input type="text"
                                        class="form-control py-2 text-center @error('cardExpiryMonth') is-invalid @enderror"
                                    ...
                                    <input type="text"
                                        class="form-control py-2 text-center border-start-0 @error('cardExpiryYear') is-invalid @enderror"
                            ...
                            <div class="col-6 mb-3">
                                ...
                                <div class="input-group">
                                    <input type="text"
                                        class="form-control py-2 border-end-0 @error('cardCvc') is-invalid @enderror"
                    ...
                    <x-card class=" d-flex flex-column">
                        ...
                        <div class="mt-auto">
                            <x-button type="primary" class="w-100 justify-content-center py-2 fw-bold shadow-sm"
                                ...
                                <span wire:loading>
                                    <x-icon name="loading" class="fa-spin me-2" /> Procesando...
                                </span>
                            </x-button>
                        </div>
                    </x-card>
