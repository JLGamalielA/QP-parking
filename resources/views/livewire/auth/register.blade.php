...
<section class="min-vh-100 bg-soft d-flex align-items-center py-5">
    <div class="container">
        {{-- Back link commented out as per original snippet --}}
        {{-- <p class="text-center"><a href="{{ route('dashboard') }}" class="text-gray-700"><x-icon name="back" class="me-2" /> Back to homepage</a></p> --}}
                    ...
                    <form wire:submit.prevent="register" action="#" method="POST">
                        <div class="form-group mb-4">
                            ...
                            <div class="input-group">
                                ...
                                <input wire:model="first_name" type="text" class="form-control" placeholder="John"
                                    id="first_name" autofocus required>
                            </div>
                            @error('first_name')
                        ...
                        <div class="form-group mb-4">
                            ...
                            <div class="input-group">
                                ...
                                <input wire:model="last_name" type="text" class="form-control" placeholder="Doe"
                        ...
                        <div class="form-group mb-4">
                            ...
                            <div class="input-group">
                                ...
                                <input wire:model.lazy="passwordConfirmation" type="password"
                                    placeholder="Confirm Password" class="form-control" id="confirm_password" required>
                            </div>
                        </div>
