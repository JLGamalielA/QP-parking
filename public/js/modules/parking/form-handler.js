...
var initParkingFormLogic = function initParkingFormLogic() {
  var typeSelect = document.getElementById("type");
  var hourlyContainer = document.getElementById("hourly-container");
  var fixedContainer = document.getElementById("fixed-container");

  // Inputs
  var hourlyInput = document.getElementById("price_per_hour");
  var fixedInput = document.getElementById("fixed_price");
  ...
  var restoreInput = function restoreInput(input) {
   ...
   */
  var toggleFields = function toggleFields() {
